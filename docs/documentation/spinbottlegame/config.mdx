...
*   **Link it to Unity:** Paste this raw URL into the **Sentences List Url** field on the `SpinBottleGameText` script.
...
*   **Reload Delay:** In the `SpinBottleGameText` script, locate the **Reload Delay** field.
